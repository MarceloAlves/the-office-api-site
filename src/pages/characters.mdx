...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://theofficeapi.dev/api/character/640150efe4cd7dc24960d943 \
      -d includeEpisodes=true
    ```
